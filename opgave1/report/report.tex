...
\hypersetup
{
	...
	citecolor=RoyalBlue,
	urlcolor=RoyalBlue,
  pdftitle={HCI Exam Paper},
  pdfauthor={Oleksandr Shturmov},
  pdfkeywords={HCI, exam, website, design, interaction},
  pdfstartview={FitV},
	bookmarksnumbered
}
...
\titel{Group Assignment 1}
\undertitel{Styresystemer og Multiprogrammering}
\opgave{}
\forfatter{Martin Grunbaum(31-03-88) \& Sebastian Paaske(23-06-88)}
\dato{February 14th, 2011}
\vejleder{}
...
\pagestyle{fancy}
\lhead{\mono{Martin G., Sebastian P.}\\\mono{31-03-88, 23-06-88}}
\chead{\mono{Styresystemer og Multiprogrammering}\\\mono{Group Assignment 1}}
\rhead{\mono{DIKU}\\\mono{February 14th, 2011}}
